...
namespace SnmpDotNet.Test
{
    ...
    public class SerializationV1Test
    {
        ...
        public void ShouldThrowDecodeExceptionOnWrongSnmpVersion()
        {
            ...
            {
                _ = SnmpV1Message.ReadFrom(reader);
            });
        }
        ...
        public void DecodeEncodeV1GetNextRequestMessage()
        {
            var dump = @"Sending 43 bytes to UDP: [127.0.0.1]:161->[0.0.0.0]:0
                ...
                0016: 04 09 4D D2  15 02 01 00  02 01 00 30  0E 30 0C 06    ..M........0.0..
                0032: 08 2B 06 01  02 01 01 01  00 05 00                    .+.........";
        ...
        [Fact]
        public void DecodeEncodeV1GetNextResponseMessage()
        {
            var dump = @"Received 53 byte packet from UDP: [127.0.0.1]:161->[0.0.0.0]:55146
                0000: 30 33 02 01  00 04 06 70  75 62 6C 69  63 A2 26 02    03.....public.&.
                0016: 04 09 4D D2  15 02 01 00  02 01 00 30  18 30 16 06    ..M........0.0..
